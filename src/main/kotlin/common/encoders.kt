...
@ExperimentalSerializationApi
class FirebaseEncoder(internal val shouldEncodeElementDefault: Boolean, positiveInfinity: Any) : TimestampEncoder(positiveInfinity),
    Encoder {
    ...
    override fun beginStructure(descriptor: SerialDescriptor): CompositeEncoder = structureEncoder(descriptor)
...
open class FirebaseCompositeEncoder constructor(
    ...
    override fun <T : Any> encodeNullableSerializableElement(descriptor: SerialDescriptor, index: Int, serializer: SerializationStrategy<T>, value: T?) =
        set(descriptor, index, value?.let { FirebaseEncoder(shouldEncodeElementDefault, positiveInfinity).apply { encodeSerializableValue(
            serializer, value
        ) }.value })

    override fun <T> encodeSerializableElement(descriptor: SerialDescriptor, index: Int, serializer: SerializationStrategy<T>, value: T)  =
        set(descriptor, index, FirebaseEncoder(shouldEncodeElementDefault, positiveInfinity).apply { encodeSerializableValue(
            serializer, value
        ) }.value)
